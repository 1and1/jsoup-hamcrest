...
image::https://img.shields.io/github/license/oneandone/jsoup-hamcrest[link=license.txt,float=left]
image::https://img.shields.io/travis/oneandone/jsoup-hamcrest[float=left]
--
